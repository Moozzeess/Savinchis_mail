...
export const blockSchema = z.discriminatedUnion('type', [
  z.object({ id: z.string(), type: z.literal('text'), content: textBlockSchema, visibility: visibilitySchema.default({ device: 'all' }) }),
  z.object({ id: z.string(), type: z.literal('image'), content: imageBlockSchema, visibility: visibilitySchema.default({ device: 'all' }) }),
  z.object({ id: z.string(), type: z.literal('button'), content: buttonBlockSchema, visibility: visibilitySchema.default({ device: 'all' }) }),
  z.object({ id: z.string(), type: z.literal('spacer'), content: spacerBlockSchema, visibility: visibilitySchema.default({ device: 'all' }) }),
  z.object({ id: z.string(), type: z.literal('divider'), content: dividerBlockSchema, visibility: visibilitySchema.default({ device: 'all' }) }),
  z.object({ id: z.string(), type: z.literal('html'), content: htmlBlockSchema, visibility: visibilitySchema.default({ device: 'all' }) }),
]);
