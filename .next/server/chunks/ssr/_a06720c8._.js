...
"[project]/src/actions/data:5543f6 [app-ssr] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$actions$2f$data$3a$5543f6__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/actions/data:5543f6 [app-ssr] (ecmascript) <text/javascript>");
'use client';
;
;
;
...
function DeleteTemplateButton({ templateId }) {
    ...
    const handleDelete = async ()=>{
        setIsDeleting(true);
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$actions$2f$data$3a$5543f6__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["deleteTemplateAction"])(templateId);
            if (result.success) {
                toast({
...
//# sourceMappingURL=_a06720c8._.js.map